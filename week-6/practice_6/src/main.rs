fn main() {
    ...
    let w3 = w1 + &w2;
    println!();
    println!("{} is aimed at developing competent, creative, innovative, entreprenurial and ethically-ided persons, capable of creating value in the diverse fields of Computer Science.",w3 );
}
